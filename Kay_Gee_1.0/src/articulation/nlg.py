...
class PersonalityTuner:
    ...
    def __init__(self, personality_core=None):
        self.personality = personality_core
        self.current_personality = "balanced"  # Default personality
    
    def set_personality(self, philosopher: str) -> None:
        """Set current personality based on philosopher"""
        self.current_personality = philosopher
