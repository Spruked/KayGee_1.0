...
# Set matplotlib backend before any imports to avoid GUI issues
import matplotlib
matplotlib.use('Agg')
...
class PhonatoryOutputModule:
    ...
    def __init__(self, config_path=None):
        ...
        # Load config - find relative to this module if not specified
        if config_path is None:
            import os
            module_dir = os.path.dirname(os.path.abspath(__file__))
            config_path = os.path.join(module_dir, "voice_config.json")
