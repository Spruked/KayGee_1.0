...
try:
    ...
    try:
        try:
            try:
                try:
                    from rich.progress import Progress, BarColumn, TextColumn  # If you see an import error, run: pip install rich
                except ImportError:
                    import importlib
    ...
    try:
        ...
        print("[ERROR] Missing 'rich' library or one of its modules. Please install it with: pip install rich")
        Console = None
        Live = None
        Layout = None
        Panel = None
